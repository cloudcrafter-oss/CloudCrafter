...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@ui/components/ui/accordion.tsx'
...
export const LayoutSidebarNav = ({ items, setOpen, className }: SideNavProps) => {
