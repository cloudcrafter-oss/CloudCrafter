...
export function getProjectEnvironmentEnhancedQueryOptions(id: GetProjectEnvironmentEnhancedPathParams["id"], environmentId: GetProjectEnvironmentEnhancedPathParams["environmentId"], options: GetProjectEnvironmentEnhanced["client"]["parameters"] = {}) {
 ...
 */
export function useGetProjectEnvironmentEnhancedHook<TData = GetProjectEnvironmentEnhanced["response"], TQueryData = GetProjectEnvironmentEnhanced["response"], TQueryKey extends QueryKey = GetProjectEnvironmentEnhancedQueryKey>(id: GetProjectEnvironmentEnhancedPathParams["id"], environmentId: GetProjectEnvironmentEnhancedPathParams["environmentId"], options: {
    query?: Partial<QueryObserverOptions<GetProjectEnvironmentEnhanced["response"], GetProjectEnvironmentEnhanced["error"], TData, TQueryData, TQueryKey>>;
    ...
    const query = useQuery({
        ...getProjectEnvironmentEnhancedQueryOptions(id, environmentId, clientOptions) as unknown as QueryObserverOptions,
        queryKey,
...
export function getProjectEnvironmentEnhancedInfiniteQueryOptions(id: GetProjectEnvironmentEnhancedPathParams["id"], environmentId: GetProjectEnvironmentEnhancedPathParams["environmentId"], options: GetProjectEnvironmentEnhanced["client"]["parameters"] = {}) {
...
export function useGetProjectEnvironmentEnhancedHookInfinite<TData = InfiniteData<GetProjectEnvironmentEnhanced["response"]>, TQueryData = GetProjectEnvironmentEnhanced["response"], TQueryKey extends QueryKey = GetProjectEnvironmentEnhancedInfiniteQueryKey>(id: GetProjectEnvironmentEnhancedPathParams["id"], environmentId: GetProjectEnvironmentEnhancedPathParams["environmentId"], options: {
    ...
    const query = useInfiniteQuery({
        ...getProjectEnvironmentEnhancedInfiniteQueryOptions(id, environmentId, clientOptions) as unknown as InfiniteQueryObserverOptions,
        queryKey,
        ...queryOptions as unknown as Omit<InfiniteQueryObserverOptions, "queryKey">
    }) as UseInfiniteQueryResult<TData, GetProjectEnvironmentEnhanced["error"]> & {
        queryKey: TQueryKey;
    };
    query.queryKey = queryKey as TQueryKey;
    return query;
...
export function getProjectEnvironmentEnhancedSuspenseQueryOptions(id: GetProjectEnvironmentEnhancedPathParams["id"], environmentId: GetProjectEnvironmentEnhancedPathParams["environmentId"], options: GetProjectEnvironmentEnhanced["client"]["parameters"] = {}) {
 ...
 * @link /api/Projects/:id/:environmentId
 */
export function useGetProjectEnvironmentEnhancedHookSuspense<TData = GetProjectEnvironmentEnhanced["response"], TQueryKey extends QueryKey = GetProjectEnvironmentEnhancedSuspenseQueryKey>(id: GetProjectEnvironmentEnhancedPathParams["id"], environmentId: GetProjectEnvironmentEnhancedPathParams["environmentId"], options: {
    query?: Partial<UseSuspenseQueryOptions<GetProjectEnvironmentEnhanced["response"], GetProjectEnvironmentEnhanced["error"], TData, TQueryKey>>;
    client?: GetProjectEnvironmentEnhanced["client"]["parameters"];
