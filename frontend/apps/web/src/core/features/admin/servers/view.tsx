import { ServerDetailDto } from '@/src/core/generated'
            ...
            <div>
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Manage your server settings for your Docker applications.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input id="username" type="password" defaultValue="myusername" autoComplete="username"/>
                        </div>
                        <div className="grid gap-2">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input id="docker-registry" defaultValue="https://registry.example.com"/>
                        </div>
                    </CardContent>
                    <CardFooter>
            ...
            <div>
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>View the latest deployments for your applications.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="grid gap-4">
                            <div className="grid grid-cols-[40px_1fr] items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">Deployed 2 hours ago</div>
                                </div>
                            </div>
                            <div className="grid grid-cols-[40px_1fr] items-center gap-4">
                                <div
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">Deployed 4 hours ago</div>
                                </div>
                            </div>
                            <div className="grid grid-cols-[40px_1fr] items-center gap-4">
                                <div
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">Deployed 6 hours ago</div>
                                </div>
                            </div>
                        </div>
                    </CardContent>
