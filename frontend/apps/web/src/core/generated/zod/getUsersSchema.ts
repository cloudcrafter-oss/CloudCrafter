...
export const getUsersMutationRequestSchema = z.lazy(
	() => userDtoPaginatedRequestSchema,
)
/**
 * @description OK
 */
export const getUsersMutationResponseSchema = z.lazy(
	() => userDtoPaginatedListSchema,
)
