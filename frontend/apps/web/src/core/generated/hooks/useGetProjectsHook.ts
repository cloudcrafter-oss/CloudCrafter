 ...
 * @link /api/Projects
 */
export function useGetProjectsHook<
...
export type GetProjectsInfiniteQueryKey = ReturnType<
	typeof getProjectsInfiniteQueryKey
>
export function getProjectsInfiniteQueryOptions(
	params?: GetProjects['queryParams'],
	options: GetProjects['client']['parameters'] = {},
) {
 ...
 * @link /api/Projects
 */
export function useGetProjectsHookInfinite<
	TData = InfiniteData<GetProjects['response']>,
	TQueryData = GetProjects['response'],
 ...
 * @link /api/Projects
 */
export function useGetProjectsHookSuspense<
	TData = GetProjects['response'],
