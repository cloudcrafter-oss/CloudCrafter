...
export function useTestHook<
	TData = Test['response'],
	TQueryData = Test['response'],
	TQueryKey extends QueryKey = TestQueryKey,
>(
	options: {
		query?: Partial<
			QueryObserverOptions<
...
export function testInfiniteQueryOptions(
	options: Test['client']['parameters'] = {},
) {
 ...
 * @link /api/Users/test
 */
export function useTestHookInfinite<
	TData = InfiniteData<Test['response']>,
	TQueryData = Test['response'],
	TQueryKey extends QueryKey = TestInfiniteQueryKey,
>(
	options: {
		query?: Partial<
			InfiniteQueryObserverOptions<
...
export function testSuspenseQueryOptions(
	options: Test['client']['parameters'] = {},
) {
 ...
 * @link /api/Users/test
 */
export function useTestHookSuspense<
	TData = Test['response'],
	TQueryKey extends QueryKey = TestSuspenseQueryKey,
>(
	options: {
		query?: Partial<
			UseSuspenseQueryOptions<Test['response'], Test['error'], TData, TQueryKey>
		>
		client?: Test['client']['parameters']
	} = {},
