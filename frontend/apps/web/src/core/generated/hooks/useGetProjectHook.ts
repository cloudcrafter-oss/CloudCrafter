 ...
 */
export function useGetProjectHook<
...
export const getProjectInfiniteQueryKey = (id: GetProjectPathParams['id']) =>
	[{ url: '/api/Projects/:id', params: { id: id } }] as const
export type GetProjectInfiniteQueryKey = ReturnType<
	typeof getProjectInfiniteQueryKey
>
export function getProjectInfiniteQueryOptions(
	id: GetProjectPathParams['id'],
	options: GetProject['client']['parameters'] = {},
) {
 ...
 * @link /api/Projects/:id
 */
export function useGetProjectHookInfinite<
	TData = InfiniteData<GetProject['response']>,
	TQueryData = GetProject['response'],
...
export const getProjectSuspenseQueryKey = (id: GetProjectPathParams['id']) =>
	[{ url: '/api/Projects/:id', params: { id: id } }] as const
 ...
 * @link /api/Projects/:id
 */
export function useGetProjectHookSuspense<
	TData = GetProject['response'],
