...
type GetFilterableFieldsClient = typeof client<
	GetFilterableFieldsQueryResponse,
	never,
	never
>
...
export const getFilterableFieldsQueryKey = () =>
	[{ url: '/api/System/get-fields' }] as const
export type GetFilterableFieldsQueryKey = ReturnType<
	typeof getFilterableFieldsQueryKey
>
export function getFilterableFieldsQueryOptions(
	options: GetFilterableFields['client']['parameters'] = {},
) {
...
export function useGetFilterableFieldsHook<
	TData = GetFilterableFields['response'],
	TQueryData = GetFilterableFields['response'],
	TQueryKey extends QueryKey = GetFilterableFieldsQueryKey,
>(
	options: {
		query?: Partial<
			QueryObserverOptions<
				GetFilterableFields['response'],
				GetFilterableFields['error'],
				TData,
				TQueryData,
				TQueryKey
	...
	const query = useQuery({
		...(getFilterableFieldsQueryOptions(
			clientOptions,
...
export const getFilterableFieldsInfiniteQueryKey = () =>
	[{ url: '/api/System/get-fields' }] as const
export type GetFilterableFieldsInfiniteQueryKey = ReturnType<
	typeof getFilterableFieldsInfiniteQueryKey
>
export function getFilterableFieldsInfiniteQueryOptions(
	options: GetFilterableFields['client']['parameters'] = {},
) {
 ...
 * @link /api/System/get-fields
 */
export function useGetFilterableFieldsHookInfinite<
	TData = InfiniteData<GetFilterableFields['response']>,
	TQueryData = GetFilterableFields['response'],
...
>(
	...
	const { query: queryOptions, client: clientOptions = {} } = options ?? {}
	const queryKey =
		queryOptions?.queryKey ?? getFilterableFieldsInfiniteQueryKey()
	const query = useInfiniteQuery({
		...(getFilterableFieldsInfiniteQueryOptions(
			clientOptions,
...
export const getFilterableFieldsSuspenseQueryKey = () =>
	[{ url: '/api/System/get-fields' }] as const
export type GetFilterableFieldsSuspenseQueryKey = ReturnType<
	typeof getFilterableFieldsSuspenseQueryKey
>
export function getFilterableFieldsSuspenseQueryOptions(
	options: GetFilterableFields['client']['parameters'] = {},
) {
 ...
 * @link /api/System/get-fields
 */
export function useGetFilterableFieldsHookSuspense<
	TData = GetFilterableFields['response'],
...
>(
	...
	const { query: queryOptions, client: clientOptions = {} } = options ?? {}
	const queryKey =
		queryOptions?.queryKey ?? getFilterableFieldsSuspenseQueryKey()
	const query = useSuspenseQuery({
		...(getFilterableFieldsSuspenseQueryOptions(
			clientOptions,
		) as unknown as QueryObserverOptions),
		queryKey,
		...(queryOptions as unknown as Omit<QueryObserverOptions, 'queryKey'>),
