...
type PostCreateDeploymentClient = typeof client<
	PostCreateDeploymentMutationResponse,
	never,
	never
>
 ...
 */
export function usePostCreateDeploymentHook(
	applicationId: PostCreateDeploymentPathParams['applicationId'],
	options: {
		mutation?: UseMutationOptions<
			PostCreateDeployment['response'],
			PostCreateDeployment['error'],
			PostCreateDeployment['request']
		>
