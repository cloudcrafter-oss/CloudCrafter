...
export function getServersQueryOptions(
	options: GetServers['client']['parameters'] = {},
) {
 ...
 * @link /api/Servers
 */
export function useGetServersHook<
	TData = GetServers['response'],
	TQueryData = GetServers['response'],
	TQueryKey extends QueryKey = GetServersQueryKey,
>(
	options: {
		query?: Partial<
			QueryObserverOptions<
...
export const getServersInfiniteQueryKey = () =>
	[{ url: '/api/Servers' }] as const
export type GetServersInfiniteQueryKey = ReturnType<
	typeof getServersInfiniteQueryKey
>
export function getServersInfiniteQueryOptions(
	options: GetServers['client']['parameters'] = {},
) {
 ...
 * @link /api/Servers
 */
export function useGetServersHookInfinite<
	TData = InfiniteData<GetServers['response']>,
	TQueryData = GetServers['response'],
...
>(
	...
	const query = useInfiniteQuery({
		...(getServersInfiniteQueryOptions(
			clientOptions,
...
export const getServersSuspenseQueryKey = () =>
	[{ url: '/api/Servers' }] as const
export type GetServersSuspenseQueryKey = ReturnType<
	typeof getServersSuspenseQueryKey
>
export function getServersSuspenseQueryOptions(
	options: GetServers['client']['parameters'] = {},
) {
 ...
 * @link /api/Servers
 */
export function useGetServersHookSuspense<
	TData = GetServers['response'],
...
>(
	...
	const query = useSuspenseQuery({
		...(getServersSuspenseQueryOptions(
			clientOptions,
		) as unknown as QueryObserverOptions),
		queryKey,
		...(queryOptions as unknown as Omit<QueryObserverOptions, 'queryKey'>),
