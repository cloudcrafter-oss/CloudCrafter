...
import type {
	GetServerByIdPathParams,
	GetServerByIdQueryResponse,
} from '../types/GetServerById'

type GetServerByIdClient = typeof client<
	GetServerByIdQueryResponse,
	never,
	never
>
...
export const getServerByIdQueryKey = (id: GetServerByIdPathParams['id']) =>
	[{ url: '/api/Servers/:id', params: { id: id } }] as const
export type GetServerByIdQueryKey = ReturnType<typeof getServerByIdQueryKey>
export function getServerByIdQueryOptions(
	id: GetServerByIdPathParams['id'],
	options: GetServerById['client']['parameters'] = {},
) {
...
export function useGetServerByIdHook<
	TData = GetServerById['response'],
	TQueryData = GetServerById['response'],
...
export const getServerByIdInfiniteQueryKey = (
	id: GetServerByIdPathParams['id'],
) => [{ url: '/api/Servers/:id', params: { id: id } }] as const
export type GetServerByIdInfiniteQueryKey = ReturnType<
	typeof getServerByIdInfiniteQueryKey
>
export function getServerByIdInfiniteQueryOptions(
	id: GetServerByIdPathParams['id'],
	options: GetServerById['client']['parameters'] = {},
) {
 ...
 * @link /api/Servers/:id
 */
export function useGetServerByIdHookInfinite<
	TData = InfiniteData<GetServerById['response']>,
	TQueryData = GetServerById['response'],
...
>(
	...
	const query = useInfiniteQuery({
		...(getServerByIdInfiniteQueryOptions(
			id,
			clientOptions,
...
export const getServerByIdSuspenseQueryKey = (
	id: GetServerByIdPathParams['id'],
) => [{ url: '/api/Servers/:id', params: { id: id } }] as const
export type GetServerByIdSuspenseQueryKey = ReturnType<
	typeof getServerByIdSuspenseQueryKey
>
export function getServerByIdSuspenseQueryOptions(
	id: GetServerByIdPathParams['id'],
	options: GetServerById['client']['parameters'] = {},
) {
 ...
 * @link /api/Servers/:id
 */
export function useGetServerByIdHookSuspense<
	TData = GetServerById['response'],
...
>(
	...
	const query = useSuspenseQuery({
		...(getServerByIdSuspenseQueryOptions(
			id,
			clientOptions,
		) as unknown as QueryObserverOptions),
		queryKey,
