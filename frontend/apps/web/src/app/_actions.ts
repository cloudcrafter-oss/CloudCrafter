...
import { createProject } from '@cloudcrafter/api/__generated__/axios-backend'
import type { CreateProjectCommandCommand } from '@cloudcrafter/api/__generated__/types/CreateProjectCommandCommand'
