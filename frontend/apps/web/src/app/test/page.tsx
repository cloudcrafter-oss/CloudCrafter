			...
			<div className='flex-1 flex flex-col overflow-hidden'>
				...
				<header className='flex items-center justify-between p-4 bg-white border-b'>
					...
					<div className='flex items-center space-x-4'>
						...
						<Button>
							New task
							<span className='ml-2 text-xs bg-blue-200 text-blue-600 rounded-full px-2'>
								N
							</span>
						</Button>
						<Button variant='outline' className='hidden sm:inline-flex'>
					...
					<div className='flex flex-col space-y-4 lg:flex-row lg:space-x-4 lg:space-y-0'>
										...
										<Card>
											<CardContent className='p-4'>
												...
												<p className='text-sm text-gray-500 mt-1'>
													Configure Docker for remote deployments
												</p>
						...
						<Card className='flex-1'>
							<CardContent>
								...
								<ScrollArea className='h-[calc(100vh-200px)] lg:h-[calc(100vh-240px)]'>
									<div className='space-y-4'>{/* Task cards go here */}</div>
								</ScrollArea>
							</CardContent>
						</Card>
		...
		<div className='h-full bg-white border-r flex flex-col'>
			...
			<ScrollArea className='flex-1'>
				<nav className='space-y-2 px-3'>
					...
					<a
						href='#'
						className='flex items-center px-3 py-2 bg-blue-50 text-blue-600 rounded-lg font-medium'
					>
