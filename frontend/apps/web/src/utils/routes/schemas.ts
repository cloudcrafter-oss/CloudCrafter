...
export type ProjectEnvironmentRouteParams = z.infer<typeof projectEnvironmentRouteSchema>;

export function validateRouteParams(params: unknown): ProjectEnvironmentRouteParams {
