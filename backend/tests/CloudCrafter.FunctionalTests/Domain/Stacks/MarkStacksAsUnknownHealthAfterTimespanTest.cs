...
public class MarkStacksAsUnknownHealthAfterTimespanTest : BaseTestFixture
{
    ...
    public async Task ShouldNotUpdateDatesButShouldMarkThemUnhealthy()
    {
        ...
        stackFromDb!.HealthStatus.StatusAt.Should().BeCloseTo(yesterday, TimeSpan.FromSeconds(1));
        ...
        serviceFromDb!.HealthStatus.StatusAt.Should().BeCloseTo(yesterday, TimeSpan.FromSeconds(1));
