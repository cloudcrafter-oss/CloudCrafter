...
To update the database use this command from the Web project folder (replace `CloudCrafter` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../CloudCrafter.Infrastructure/CloudCrafter.Infrastructure.csproj -s CloudCrafter.Web.csproj
```
